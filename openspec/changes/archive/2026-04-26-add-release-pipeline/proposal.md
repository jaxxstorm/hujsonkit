...
- Publish through npm trusted publishing with GitHub Actions OIDC rather than a long-lived npm token.
...
- Packaging impact: maintainers get a repeatable local release command, and npm publication remains controlled by GitHub Actions OIDC after a matching version tag is pushed.
